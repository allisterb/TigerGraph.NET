...
{
 "use strict";
 var Global,TigerGraph,Client,WebSharper,Obj,Base,Runtime,Runtime$1,ApiClient,RuntimeModule,UI,Client$1,Templates,Doc,JavaScript,Pervasives,Operators,EventTarget,Node,JS,Collections,Dictionary,Unchecked,Logger,JSConLogger,CancellationTokenSource,SC$1,Arrays,HashSet,Seq,WindowOrWorkerGlobalScope,View,Docs,Numeric,Error,InvalidOperationException,DictionaryUtil,Object,Prepare,Slice,DomUtility,Enumerator,KeyCollection,DocElemNode,CharacterData,An,Settings,Abbrev,Mailbox,Strings,Attrs,Dyn,Docs$1,RunState,NodeSet,AttrProxy,Snap,Concurrency,Anims,SC$2,SC$3,T,Attrs$1,Fresh,SC$4,AppendList,SC$5,Scheduler,Easing,AsyncBody,SC$6,CT,HashSet$1,HashSetUtil,List,T$1,SC$7,Var,BindVar,String,CheckedInput,Array,DomNodes,Char,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$2,Date,console;
 Global=self;
 TigerGraph=Global.TigerGraph=Global.TigerGraph||{};
 Client=TigerGraph.Client=TigerGraph.Client||{};
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Obj=WebSharper.Obj=WebSharper.Obj||{};
 Base=TigerGraph.Base=TigerGraph.Base||{};
 Runtime=Base.Runtime=Base.Runtime||{};
 Runtime$1=TigerGraph.Runtime=TigerGraph.Runtime||{};
 ApiClient=TigerGraph.ApiClient=TigerGraph.ApiClient||{};
 RuntimeModule=TigerGraph.RuntimeModule=TigerGraph.RuntimeModule||{};
 ...
 Logger=TigerGraph.Logger=TigerGraph.Logger||{};
 JSConLogger=TigerGraph.JSConLogger=TigerGraph.JSConLogger||{};
 ...
 Obj.New=Runtime$2.Ctor(function()
 {
 },Obj);
 Runtime.$cctor=function()
 {
  Runtime.$cctor=Global.ignore;
  Runtime.set_Logger(null);
  Runtime.$Cts=new CancellationTokenSource.New();
  Runtime.$Ct=Runtime.get_Cts();
  Runtime.YY=Strings.Substring(Global.String((new Global.Date(Date.now())).getFullYear()),2,2);
 };
 Runtime=Base.Runtime=Runtime$2.Class({
  $init:function()
  {
   Runtime.$cctor();
   this.set_Initialized(null);
   this.set_CancellationToken(null);
  },
  set_CancellationToken:function(value)
  {
   Runtime.$cctor();
 ...
 Runtime.SetLogger=function(logger)
 {
  Runtime.$cctor();
  Runtime.set_Logger(logger);
 };
 Runtime.get_Cts=function()
 {
  Runtime.$cctor();
  return Runtime.$Cts;
 };
 Runtime.set_Logger=function(value)
 {
  Runtime.$cctor();
  Runtime.$Logger=value;
 };
 Runtime.get_Logger=function()
 {
  Runtime.$cctor();
  return Runtime.$Logger;
 };
 Runtime.New=Runtime$2.Ctor(function()
 {
  Runtime.$cctor();
  Runtime.New$1.call(this,Runtime.get_Cts());
 },Runtime);
 Runtime.New$1=Runtime$2.Ctor(function(ct)
 {
  Runtime.$cctor();
  this.$init();
  if(Unchecked.Equals(Runtime.get_Logger(),null))
   {
    throw new InvalidOperationException.New("A logger is not assigned.");
   }
  this.set_CancellationToken(ct);
 },Runtime);
 Runtime$1.$cctor=function()
 {
  Runtime$1.$cctor=Global.ignore;
  Runtime.SetLogger(new JSConLogger.New());
 };
 Runtime$1=TigerGraph.Runtime=Runtime$2.Class({},Runtime,Runtime$1);
 Runtime$1.New=Runtime$2.Ctor(function()
 {
  Runtime$1.$cctor();
  Runtime.New.call(this);
 },Runtime$1);
 ApiClient=TigerGraph.ApiClient=Runtime$2.Class({},Runtime$1,ApiClient);
 ApiClient.New=Runtime$2.Ctor(function()
 {
  Runtime$1.New.call(this);
 },ApiClient);
 RuntimeModule.info=function(a)
 {
  console.info(a);
 };
 ...
 Logger=TigerGraph.Logger=Runtime$2.Class({
  $init:function()
  {
   this.set_IsConfigured(false);
  },
  set_IsConfigured:function(value)
  {
   this.$IsConfigured=value;
  }
 },Obj,Logger);
 Logger.New=Runtime$2.Ctor(function()
 {
  this.$init();
 },Logger);
 JSConLogger=TigerGraph.JSConLogger=Runtime$2.Class({},Logger,JSConLogger);
 JSConLogger.New=Runtime$2.Ctor(function()
 {
  Logger.New.call(this);
 },JSConLogger);
      ...
      if(doc!=null&&doc.$==4)
       ...
       if(doc!=null&&doc.$==5)
        ...
        if(doc!=null&&doc.$==6)
         ...
         {
          return(((Runtime$2.Curried3(function(parent$1,el,pos$1)
          {
 ...
 InvalidOperationException=WebSharper.InvalidOperationException=Runtime$2.Class({},Error,InvalidOperationException);
 InvalidOperationException.New=Runtime$2.Ctor(function(message)
 {
  InvalidOperationException.New$2.call(this,message,null);
 },InvalidOperationException);
 InvalidOperationException.New$2=Runtime$2.Ctor(function(message,innerExn)
 {
 ...
 KeyCollection=Collections.KeyCollection=Runtime$2.Class({
 ...
 KeyCollection.New=Runtime$2.Ctor(function(d)
 {
  Obj.New.call(this);
  this.d=d;
 },KeyCollection);
 ...
 T=Enumerator.T=Runtime$2.Class({
  MoveNext:function()
  {
   return this.n(this);
  },
 ...
 T.New=Runtime$2.Ctor(function(s,c,n,d)
 {
  Obj.New.call(this);
  this.s=s;
  this.c=c;
 ...
 SC$5.$cctor=function()
 {
  ...
  SC$5.EmptyAttr=null;
  SC$5.BoolCheckedApply=Runtime$2.Curried3(function(_var,el,cb)
  {
  ...
  SC$5.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),Runtime$2.Curried(BindVar.ApplyValue,3,[g,function($1,$2)
  {
   return(s($1))($2);
  }])));
  ...
  SC$5.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),Runtime$2.Curried(BindVar.ApplyValue,3,[g$1,function($1,$2)
  {
   return(s$1($1))($2);
  }])));
  ...
  SC$5.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),Runtime$2.Curried(BindVar.ApplyValue,3,[g$2,function($1,$2)
  {
   return(s$2($1))($2);
  }])));
  ...
  SC$5.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),Runtime$2.Curried(BindVar.ApplyValue,3,[g$3,function($1,$2)
  {
   return(s$3($1))($2);
  }])));
  ...
  SC$5.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),Runtime$2.Curried(BindVar.ApplyValue,3,[g$4,function($1,$2)
  {
   return(s$4($1))($2);
  }])));
 };
 ...
 OperationCanceledException=WebSharper.OperationCanceledException=Runtime$2.Class({},Error,OperationCanceledException);
