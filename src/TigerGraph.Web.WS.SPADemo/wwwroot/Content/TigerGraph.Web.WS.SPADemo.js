...
{
 "use strict";
 var Global,TigerGraph,Client,WebSharper,Obj,UI,Doc,View,DocElemNode,EventTarget,Node,CharacterData,Snap,IntelliFactory,Runtime;
 Global=self;
 TigerGraph=Global.TigerGraph=Global.TigerGraph||{};
 Client=TigerGraph.Client=TigerGraph.Client||{};
 ...
 DocElemNode=UI.DocElemNode=Runtime.Class({},null,DocElemNode);
